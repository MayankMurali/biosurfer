...
def get_start_stop_codon_positions(s, chr, writer):
    """ 
    Function to extract start and stop codon postions 
    """
                    ...
                    if tx:
                        ...
                        for orf in tx.orfs:
                            ...
                            if last_res.amino_acid is AminoAcid.STOP:
                                ...
                                row = (gene,isoform_name,isoform_accession,start_codon,stop_codon)
                                writer.writerow(row)
...
if __name__ == "__main__":
    ...
    for chr in chrs:
        with open(f'{chr}_start_stop_codon_positions.csv', 'wt') as f:
            writer = csv.writer(f)
            writer.writerow(('gene','isoform_name','accession','codon_start','codon_stop'))
            get_start_stop_codon_positions(s, chr, writer)